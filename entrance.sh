...
UUID=${UUID:-'db33ef8b-1383-4a9a-b009-384e5fca12ca'}
VMESS_WSPATH=${VMESS_WSPATH:-'/CQvXprcb3n'}
VLESS_WSPATH=${VLESS_WSPATH:-'/q9Lkdpn3k1'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/blo5xDt'}
SS_WSPATH=${SS_WSPATH:-'/1TpSlYbfes'}
